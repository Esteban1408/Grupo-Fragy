...
public class Ejercicio_13 {
	...
	public static void main(String[] args) {
		...
		if(n1<n2) {//Esta parte determina si el primer numero es menor al segundo numero ingresado
			...
			for(int i=0;n1<=n2;n1++) {//Este ciclo for es para poner el limite de los numeros y a su vez que vaya aumentando el numero menor
				if(n1%2==0) {
			...
			for(int i=0;n2<=n1;n2++) {//Este ciclo for es para poner el limite de los numeros y a su vez que vaya aumentando el numero menor
				if(n2%2==0) {
