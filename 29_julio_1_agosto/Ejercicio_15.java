...
public class Ejercicio_15 {
	...
	public static void main(String[] args) {
		// Agregar validaciones a calculadora (caracteres inválidos regresar a menu principal) cuando se termine una operación preguntar 
		//si desea realizar otra operación o salir y permitir decimales en las operaciones
